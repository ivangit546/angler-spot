...
urlpatterns = [
    ...
    #Direct Messages
    path('message/<int:user_id>', CreateGroupChat.as_view(), name='create_group_chat'),
    path('chats/', ChatListView.as_view(), name='group_chats'),
    path('direct_message/<int:gc_id>', ChatView.as_view(), name='direct_message'),
