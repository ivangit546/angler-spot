...
class Fish(models.Model):
    ...
    shiny = models.CharField(max_length=100, null=True) # might remove later as it could be redundant-> change 'shiny' to charfield and if not null then alr has boolean value assumed(true)
    fish_avatar = models.ImageField(upload_to='fish_avatar/') #will be stock image for type of fish
